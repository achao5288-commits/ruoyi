...
mysql -uroot -p123456 -D ruoyi-vue-pro -N -e "SELECT 1;" >nul 2>&1
if errorlevel 1 (
...
if defined BACKEND_PID (
    ...
    start "RuoYi-Vue-Pro Backend" /D "%ROOT%" powershell.exe -NoExit -NoProfile -ExecutionPolicy Bypass -Command "& '%JAVA_HOME%\bin\java.exe' -jar '%SERVER_JAR%' '--spring.profiles.active=local'"
)
